...
{
    /// <summary>
    /// Calculates the Federal Insurance Contributions Act tax based on income and effective date
    /// </summary>
    public interface IFICACalculator
    {
        FICAResult Calculate(DateTime checkDate, Decimal annualizedIncome);
    }
    ...
    public class FICACalculator : IFICACalculator
    {
        ...
        public FICAResult Calculate(DateTime checkDate, decimal annualizedIncome)
        {            
